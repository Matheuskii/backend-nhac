    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/produtos/**").hasAnyRole("LOJISTA", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/v1/produtos/**").permitAll()
                        .requestMatchers("/api/v1/lojista/**").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/v1/produtos").hasAnyRole("LOJISTA", "ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/produtos/**").hasAnyRole("LOJISTA", "ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/produtos/**").hasAnyRole("LOJISTA", "ADMIN")
