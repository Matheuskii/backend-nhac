...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/lojas/**").hasAnyRole("LOJISTA", "FUNCIONARIO", "ADMIN")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Origens específicas exigidas pelo Spring quando allowCredentials=true (não aceita "*").
        // Se o domínio de produção/deploy mudar, é aqui que precisa ser atualizado.
